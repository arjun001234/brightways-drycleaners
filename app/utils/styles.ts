...
export const basicButton = "min-h-[40px] h-auto w-full lg:w-auto flex justify-center items-center px-[30px] rounded-md lg:rounded-[30px] border-2 border-gray-400 font-text font-medium text-[18px] dark:text-white text-black hover:border-blue hover:scale-110 transition-all duration-300"
...
export const largeRoundedBasicButton = "min-h-[60px] h-auto w-[60px] flex justify-center items-center px-[30px] rounded-[50%] border-2 border-gray-400 font-text font-medium text-[18px] dark:text-white text-black hover:border-blue hover:scale-110 transition-all duration-300"
