...
const Footer = () => {
  ...
  return (
    <div className='w-full max-w-[100vw] bg-inherit flex justify-center items-center mx-auto px-[20px] md:px-[100px] h-auto gap-10 py-[100px] border-t-2 border-gray-400'>
