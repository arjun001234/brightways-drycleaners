...
const DeatailedService : React.FC<DetailedServiceProps> = ({service}) => {
  ...
  return (
    <div  className={`flex flex-col-reverse lg:flex-row lg:even:flex-row-reverse items-center gap-20 overflow-visible odd:animate-bounce-in-right even:animate-bounce-in-left`}>
